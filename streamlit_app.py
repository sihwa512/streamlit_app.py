...
# --- 1. 核心連線設定 ---
st.set_page_config(page_title="退休戰情室 V89.2", layout="wide")
...
# --- 6. 儀表板 ---
st.markdown(f"#### 🛡️ 退休戰情室 V89.2 (雙核防呆版)")
st.markdown(f"""
...
# 🌟 透過 Session State 防護，無論從哪邊儲存都不會遺失
with t_col4:
...
with st.sidebar:
    ...
    # 加入 key 屬性，讓 Session state 自動記憶
